            ...
            <div style={{ background: theme.card, borderRadius: '1.5rem', boxShadow: '0 8px 32px rgba(26,35,126,0.12)', border: `1px solid ${theme.border}` }} className="p-4">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  <input type="text" name="name" value={form.name} onChange={handleChange} required className="form-control" style={{ borderRadius: '1rem', border: `1px solid ${theme.secondary}` }} />
                </div>
                <div className="mb-3">
                ...
                <button type="submit" className="btn w-100 fw-bold" style={{ background: theme.secondary, color: '#fff', borderRadius: '2rem', fontSize: '1.1rem', boxShadow: '0 2px 8px rgba(100,181,246,0.15)' }}>Register</button>
              </form>
            </div>
          </div>
        </div>
